...
new _vue2.default({
    ...
    methods: {
        getAllPosts: function getAllPosts() {
            ...
            this.$http.get(this.endpoint, options).then(function (result) {
                console.log(result);
